    ...
    <div class="row hero-columns">
        <div class="col-md-6">
            ...
            <div class="d-flex flex-row gap-3">
                ...
                <button class="second-btn d-flex flex-wor align-items-center gap-3">
...
<div class="news-container">
    <div class="container">
        <div class="row news-row flex-nowrap pb-5">
            <?php
